...
This script:
Simulates various orbital radii. Computes the corresponding orbital periods. Plots \( T^2 \) vs. \( r^3 \), which should yield a straight line, confirming Kepler's Third Law.
