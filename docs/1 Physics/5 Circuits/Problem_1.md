...
# Define the nested resistor circuit (Example 2)
G = nx.Graph()
G.add_edge(0, 1, weight=4)
G.add_edge(1, 2, weight=6)
G.add_edge(2, 3, weight=8)
G.add_edge(1, 3, weight=3)  # Parallel connection
G.add_edge(0, 3, weight=2)  # Parallel connection
...
plt.title("Nested Resistor Circuit")
plt.show()
```
![alt text](image.png)